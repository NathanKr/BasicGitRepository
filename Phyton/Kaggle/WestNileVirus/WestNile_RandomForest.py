...
#root = "E:\\nathan\\Kaggle\\Fresh\\"
root = ".\\Fresh\\"
# X_train , test , sample , weather are type DataFrame 
...
lbl.fit(list(X_train['Species'].values) + list(test['Species'].values))
X_train['Species'] = lbl.transform(X_train['Species'].values)
test['Species'] = lbl.transform(test['Species'].values)

lbl.fit(list(X_train['Street'].values) + list(test['Street'].values))
X_train['Street'] = lbl.transform(X_train['Street'].values)
test['Street'] = lbl.transform(test['Street'].values)

lbl.fit(list(X_train['Trap'].values) + list(test['Trap'].values))
...
# up until now we simply prepared the data : X_train \ test
